...
class App extends Component {
  state = {
    activeEmojiOptionId: emojisListss[0].emojiName,
    activeDaysOptionId: daysListss[0].dayNumber,
    activeEmojiId: emojisListss[0].id,
    activeMonth: initialMonthsList[0].monthName,
    activeMonthNumber: initialMonthsList[0].month,
    monthsList: initialMonthsList,
    daysList: daysListss,
    emojisList: emojisListss,
    activeEmojiUrl: emojisListss[0].emojiUrl,
    activeEmojiName: emojisListss[0].emojiName,
    emojisUrl: '',
    activeDayButton: '',
  ...
  increaseFn = () => {
    ...
    this.setState({
      activeMonth: initialMonthsList[count].monthName,
      activeMonthNumber: initialMonthsList[count].month,
    })
  }
  ...
  emojiCountFn = () => {
    ...
    return <p className="appEmojiCountText">{emojiesCount}</p>
  }
    ...
    return (
      <MoodTrackerContext.Provider
        value={{
          ...
          activeMonthFilter,
          emojiesMonthwiseCount,
          increaseFn: this.increaseFn,
          decreaseFn: this.decreaseFn,
          displayEmoji: this.displayEmoji,
          onChangeEmojiOption: this.onChangeEmojiOption,
          onChangeDaysOption: this.onChangeDaysOption,
          emojiChange: this.emojiChange,
          emojiCountFn: this.emojiCountFn,
          onChangeActiveMonthName: this.onChangeActiveMonthName,
          reChartFn: this.reChartFn,
          isActive,
          onClickActiveHome: this.onClickActiveHome,
          onClickActiveReport: this.onClickActiveReport,
        }}
      >
        <Switch>
